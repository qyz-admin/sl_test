...
print('颜色') 
print(sheet['A108'].style) 
print(sheet['A108'].style_id) 
print('字体') 
print(sheet['A108'].font) 
print('居中') 
print(sheet['A108'].alignment) 

print('边框') 
print(sheet['A108'].border)

sheet.column_dimensions['D'].width = 22.5
sheet.column_dimensions['E'].width = 25
print('填充') 
print(sheet['A108'].fill)
# print('填充0') 
# print(sheet['A107'].fill)
# print('填充1') 
# print(sheet['A106'].fill)


print('填充1111') 
sheet['D96'].fill = PatternFill(patternType='solid',fgColor='1874CD')
sheet['D97'].fill = PatternFill(patternType='solid',start_color ='FFFF00', end_color = 'FFFF00')
sheet['D94'].font = Font(color='00FF0000')
wb.save(filePath)
